...
g=[],h=0,k=a.length,l=null!=b;k>h;h++)(f=a[h])&&(!c||c(f,d,e))&&(g.push(f),l&&b.push(h));return g}function r(a,c,f,g,h,k){return g&&!g[y]&&(g=r(g)),h&&!h[y]&&(h=r(h,k)),d(function(d,e,k,l){var m,n,p=[],Ma=[],s=e.length,q;if(!(q=d)){q=c||"*";for(var u=k.nodeType?[k]:k,t=[],r=0,ja=u.length;ja>r;r++)b(q,u[r],t);q=t}q=!a||!d&&c?q:w(q,p,a,k,l);u=f?h||(d?a:s||g)?[]:e:q;if(f&&f(q,u,k,l),g){m=w(u,Ma);g(m,[],k,l);for(k=m.length;k--;)(n=m[k])&&(u[Ma[k]]=!(q[Ma[k]]=n))}if(d){if(h||a){if(h){m=[];for(k=u.length;k--;)(n=
u[k])&&m.push(q[k]=n);h(null,u=[],m,l)}for(k=u.length;k--;)(n=u[k])&&-1<(m=h?ia.call(d,n):p[k])&&(d[m]=!(e[m]=n))}}else u=w(u===e?u.splice(s,u.length):u),h?h(null,e,u,l):da.apply(e,u)})}function x(a){var b,c,d,e=a.length,f=q.relative[a[0].type];c=f||q.relative[" "];for(var g=f?1:0,h=u(function(a){return a===b},c,!0),k=u(function(a){return-1<ia.call(b,a)},c,!0),l=[function(a,c,d){return!f&&(d||c!==J)||((b=c).nodeType?h(a,c,d):k(a,c,d))}];e>g;g++)if(c=q.relative[a[g].type])l=[u(t(l),c)];else{if(c=q.filter[a[g].type].apply(null,
a[g].matches),c[y]){for(d=++g;e>d&&!q.relative[a[d].type];d++);return r(1<g&&t(l),1<g&&s(a.slice(0,g-1).concat({value:" "===a[g-2].type?"*":""})).replace(P,"$1"),c,d>g&&x(a.slice(g,d)),e>d&&x(a=a.slice(d)),e>d&&s(a))}l.push(c)}return t(l)}function A(a,c){var f=0<c.length,g=0<a.length,h=function(d,e,h,k,l){var m,n,p,s=0,V="0",u=d&&[],t=[],r=J,ja=d||g&&q.find.TAG("*",l),y=E+=null==r?1:Math.random()||0.1,x=ja.length;for(l&&(J=e!==C&&e);V!==x&&null!=(m=ja[V]);V++){if(g&&m){for(n=0;p=a[n++];)if(p(m,e,
h)){k.push(m);break}l&&(E=y)}f&&((m=!p&&m)&&s--,d&&u.push(m))}if(s+=V,f&&V!==s){for(n=0;p=c[n++];)p(u,t,e,h);if(d){if(0<s)for(;V--;)u[V]||t[V]||(t[V]=$.call(k));t=w(t)}da.apply(k,t);l&&!d&&0<t.length&&1<s+c.length&&b.uniqueSort(k)}return l&&(E=y,J=r),u};return f?d(h):h}var L,v,q,B,ja,va,Na,z,J,ea,ta,ca,C,R,F,D,ka,I,G,y="sizzle"+-new Date,K=a.document,E=0,Q=0,ob=c(),N=c(),O=c(),M=function(a,b){return a===b&&(ta=!0),0},H="undefined",S=-2147483648,Y={}.hasOwnProperty,fa=[],$=fa.pop,aa=fa.push,da=fa.push,
W=fa.slice,ia=fa.indexOf||function(a){for(var b=0,c=this.length;c>b;b++)if(this[b]===a)return b;return-1},X="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),Z="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+X+"))|)[\\x20\\t\\r\\n\\f]*\\]",U=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+Z+")*)|.*)\\)|)",
...
k=!k&&!h;if(q){if(f){for(;c;){for(m=b;m=m[c];)if(h?m.nodeName.toLowerCase()===nb:1===m.nodeType)return!1;s=c="only"===a&&!s&&"nextSibling"}return!0}if(s=[g?q.firstChild:q.lastChild],g&&k){k=q[y]||(q[y]={});l=k[a]||[];p=l[0]===E&&l[1];n=l[0]===E&&l[2];for(m=p&&q.childNodes[p];m=++p&&m&&m[c]||(n=p=0)||s.pop();)if(1===m.nodeType&&++n&&m===b){k[a]=[E,p,n];break}}else if(k&&(l=(b[y]||(b[y]={}))[a])&&l[0]===E)n=l[1];else for(;(m=++p&&m&&m[c]||(n=p=0)||s.pop())&&(!(h?m.nodeName.toLowerCase()===nb:1===m.nodeType)||
...
selected:function(a){return a.parentNode&&a.parentNode.selectedIndex,!0===a.selected},empty:function(a){for(a=a.firstChild;a;a=a.nextSibling)if(6>a.nodeType)return!1;return!0},parent:function(a){return!q.pseudos.empty(a)},header:function(a){return ra.test(a.nodeName)},input:function(a){return qa.test(a.nodeName)},button:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&"button"===a.type||"button"===b},text:function(a){var b;return"input"===a.nodeName.toLowerCase()&&"text"===a.type&&(null==
(b=a.getAttribute("type"))||"text"===b.toLowerCase())},first:p(function(){return[0]}),last:p(function(a,b){return[b-1]}),eq:p(function(a,b,c){return[0>c?c+b:c]}),even:p(function(a,b){for(var c=0;b>c;c+=2)a.push(c);return a}),odd:p(function(a,b){for(var c=1;b>c;c+=2)a.push(c);return a}),lt:p(function(a,b,c){for(b=0>c?c+b:c;0<=--b;)a.push(b);return a}),gt:p(function(a,b,c){for(c=0>c?c+b:c;++c<b;)a.push(c);return a})}};q.pseudos.nth=q.pseudos.eq;for(L in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})q.pseudos[L]=
k(L);for(L in{submit:!0,reset:!0})q.pseudos[L]=l(L);m.prototype=q.filters=q.pseudos;q.setFilters=new m;va=b.tokenize=function(a,c){var d,e,f,g,h,k,l;if(h=N[a+" "])return c?0:h.slice(0);h=a;k=[];for(l=q.preFilter;h;){(!d||(e=la.exec(h)))&&(e&&(h=h.slice(e[0].length)||h),k.push(f=[]));d=!1;(e=ma.exec(h))&&(d=e.shift(),f.push({value:d,type:e[0].replace(P," ")}),h=h.slice(d.length));for(g in q.filter)!(e=T[g].exec(h))||l[g]&&!(e=l[g](e))||(d=e.shift(),f.push({value:d,type:g,matches:e}),h=h.slice(d.length));
if(!d)break}return c?h.length:h?b.error(a):N(a,k).slice(0)};return Na=b.compile=function(a,b){var c,d=[],e=[],f=O[a+" "];if(!f){b||(b=va(a));for(c=b.length;c--;)f=x(b[c]),f[y]?d.push(f):e.push(f);f=O(a,A(e,d));f.selector=a}return f},z=b.select=function(a,b,c,d){var e,f,g,h,k,l="function"==typeof a&&a,m=!d&&va(a=l.selector||a);if(c=c||[],1===m.length){if(f=m[0]=m[0].slice(0),2<f.length&&"ID"===(g=f[0]).type&&v.getById&&9===b.nodeType&&F&&q.relative[f[1].type]){if(b=(q.find.ID(g.matches[0].replace(ga,
ha),b)||[])[0],!b)return c;l&&(b=b.parentNode);a=a.slice(f.shift().value.length)}for(e=T.needsContext.test(a)?0:f.length;e--&&!(g=f[e],q.relative[h=g.type]);)if((k=q.find[h])&&(d=k(g.matches[0].replace(ga,ha),ba.test(f[0].type)&&n(b.parentNode)||b))){if(f.splice(e,1),a=d.length&&s(f),!a)return da.apply(c,d),c;break}}return(l||Na(a,m))(d,b,!F,c,ba.test(a)&&n(b.parentNode)||b),c},v.sortStable=y.split("").sort(M).join("")===y,v.detectDuplicates=!!ta,ca(),v.sortDetached=f(function(a){return 1&a.compareDocumentPosition(C.createElement("div"))}),
...
b,c){var e,f,g,h,k=a.cloneNode(!0),l=d.contains(a.ownerDocument,a);if(!x.noCloneChecked&&!(1!==a.nodeType&&11!==a.nodeType||d.isXMLDoc(a))){h=B(k);g=B(a);e=0;for(f=g.length;f>e;e++){var p=g[e],n=h[e],m=n.nodeName.toLowerCase();"input"===m&&rb.test(p.type)?n.checked=p.checked:("input"===m||"textarea"===m)&&(n.defaultValue=p.defaultValue)}}if(b)if(c){g=g||B(a);h=h||B(k);e=0;for(f=g.length;f>e;e++)Xa(g[e],h[e])}else Xa(a,k);return h=B(k,"script"),0<h.length&&Da(h,!l&&B(a,"script")),k},buildFragment:function(a,
...
d.domManip(a,b)});if(k&&(c=d.buildFragment(a,this[0].ownerDocument,!1,this),e=c.firstChild,1===c.childNodes.length&&(c=e),e)){e=d.map(B(c,"script"),Mb);for(f=e.length;k>h;h++)g=c,h!==p&&(g=d.clone(g,!0,!0),f&&d.merge(e,B(g,"script"))),b.call(this[h],g,h);if(f){c=e[e.length-1].ownerDocument;d.map(e,Nb);for(h=0;f>h;h++)g=e[h],wb.test(g.type||"")&&!t.access(g,"globalEval")&&d.contains(c,g)&&(g.src?d._evalUrl&&d._evalUrl(g.src):d.globalEval(g.textContent.replace(ec,"")))}}return this}});d.each({appendTo:"append",
...
finish:function(a){return!1!==a&&(a=a||"fx"),this.each(function(){var b,c=t.get(this),e=c[a+"queue"];b=c[a+"queueHooks"];var f=d.timers,g=e?e.length:0;c.finish=!0;d.queue(this,a,[]);b&&b.stop&&b.stop.call(this,!0);for(b=f.length;b--;)f[b].elem===this&&f[b].queue===a&&(f[b].anim.stop(!0),f.splice(b,1));for(b=0;g>b;b++)e[b]&&e[b].finish&&e[b].finish.call(this);delete c.finish})}});d.each(["toggle","show","hide"],function(a,b){var c=d.fn[b];d.fn[b]=function(a,d,g){return null==a||"boolean"==typeof a?
c.apply(this,arguments):this.animate(ra(b,!0),a,d,g)}});d.each({slideDown:ra("show"),slideUp:ra("hide"),slideToggle:ra("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){d.fn[a]=function(a,d,f){return this.animate(b,a,d,f)}});d.timers=[];d.fx.tick=function(){var a,b=0,c=d.timers;for($=d.now();b<c.length;b++)a=c[b],a()||c[b]!==a||c.splice(b--,1);c.length||d.fx.stop();$=void 0};d.fx.timer=function(a){d.timers.push(a);a()?d.fx.start():d.timers.pop()};
d.fx.interval=13;d.fx.start=function(){za||(za=setInterval(d.fx.tick,d.fx.interval))};d.fx.stop=function(){clearInterval(za);za=null};d.fx.speeds={slow:600,fast:200,_default:400};d.fn.delay=function(a,b){return a=d.fx?d.fx.speeds[a]||a:a,b=b||"fx",this.queue(b,function(b,d){var f=setTimeout(b,a);d.stop=function(){clearTimeout(f)}})};(function(){var a=r.createElement("input"),b=r.createElement("select"),c=b.appendChild(r.createElement("option"));a.type="checkbox";x.checkOn=""!==a.value;x.optSelected=
c.selected;b.disabled=!0;x.optDisabled=!c.disabled;a=r.createElement("input");a.value="t";a.type="radio";x.radioValue="t"===a.value})();var zb,la=d.expr.attrHandle;d.fn.extend({attr:function(a,b){return N(this,d.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){d.removeAttr(this,a)})}});d.extend({attr:function(a,b,c){var e,f,g=a.nodeType;if(a&&3!==g&&8!==g&&2!==g)return"undefined"===typeof a.getAttribute?d.prop(a,b,c):(1===g&&d.isXMLDoc(a)||(b=b.toLowerCase(),e=d.attrHooks[b]||
(d.expr.match.bool.test(b)?zb:void 0)),void 0===c?e&&"get"in e&&null!==(f=e.get(a,b))?f:(f=d.find.attr(a,b),null==f?void 0:f):null!==c?e&&"set"in e&&void 0!==(f=e.set(a,c,b))?f:(a.setAttribute(b,c+""),c):void d.removeAttr(a,b))},removeAttr:function(a,b){var c,e,f=0,g=b&&b.match(G);if(g&&1===a.nodeType)for(;c=g[f++];)e=d.propFix[c]||c,d.expr.match.bool.test(c)&&(a[e]=!1),a.removeAttribute(c)},attrHooks:{type:{set:function(a,b){if(!x.radioValue&&"radio"===b&&d.nodeName(a,"input")){var c=a.value;return a.setAttribute("type",
b),c&&(a.value=c),b}}}}});zb={set:function(a,b,c){return!1===b?d.removeAttr(a,c):a.setAttribute(c,c),c}};d.each(d.expr.match.bool.source.match(/\w+/g),function(a,b){var c=la[b]||d.find.attr;la[b]=function(a,b,d){var h,k;return d||(k=la[b],la[b]=h,h=null!=c(a,b,d)?b.toLowerCase():null,la[b]=k),h}});var kc=/^(?:input|select|textarea|button)$/i;d.fn.extend({prop:function(a,b){return N(this,d.prop,a,b,1<arguments.length)},removeProp:function(a){return this.each(function(){delete this[d.propFix[a]||a]})}});
d.extend({propFix:{"for":"htmlFor","class":"className"},prop:function(a,b,c){var e,f,g,h=a.nodeType;if(a&&3!==h&&8!==h&&2!==h)return g=1!==h||!d.isXMLDoc(a),g&&(b=d.propFix[b]||b,f=d.propHooks[b]),void 0!==c?f&&"set"in f&&void 0!==(e=f.set(a,c,b))?e:a[b]=c:f&&"get"in f&&null!==(e=f.get(a,b))?e:a[b]},propHooks:{tabIndex:{get:function(a){return a.hasAttribute("tabindex")||kc.test(a.nodeName)||a.href?a.tabIndex:-1}}}});x.optSelected||(d.propHooks.selected={get:function(a){a=a.parentNode;return a&&a.parentNode&&
a.parentNode.selectedIndex,null}});d.each("tabIndex readOnly maxLength cellSpacing cellPadding rowSpan colSpan useMap frameBorder contentEditable".split(" "),function(){d.propFix[this.toLowerCase()]=this});var Oa=/[\t\r\n\f]/g;d.fn.extend({addClass:function(a){var b,c,e,f,g;b="string"==typeof a&&a;var h=0,k=this.length;if(d.isFunction(a))return this.each(function(b){d(this).addClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(G)||[];k>h;h++)if(c=this[h],e=1===c.nodeType&&(c.className?
(" "+c.className+" ").replace(Oa," "):" ")){for(g=0;f=b[g++];)0>e.indexOf(" "+f+" ")&&(e+=f+" ");e=d.trim(e);c.className!==e&&(c.className=e)}return this},removeClass:function(a){var b,c,e,f,g;b=0===arguments.length||"string"==typeof a&&a;var h=0,k=this.length;if(d.isFunction(a))return this.each(function(b){d(this).removeClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(G)||[];k>h;h++)if(c=this[h],e=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(Oa," "):"")){for(g=0;f=b[g++];)for(;0<=
e.indexOf(" "+f+" ");)e=e.replace(" "+f+" "," ");e=a?d.trim(e):"";c.className!==e&&(c.className=e)}return this},toggleClass:function(a,b){var c=typeof a;return"boolean"==typeof b&&"string"===c?b?this.addClass(a):this.removeClass(a):this.each(d.isFunction(a)?function(c){d(this).toggleClass(a.call(this,c,this.className,b),b)}:function(){if("string"===c)for(var b,f=0,g=d(this),h=a.match(G)||[];b=h[f++];)g.hasClass(b)?g.removeClass(b):g.addClass(b);else("undefined"===c||"boolean"===c)&&(this.className&&
t.set(this,"__className__",this.className),this.className=this.className||!1===a?"":t.get(this,"__className__")||"")})},hasClass:function(a){a=" "+a+" ";for(var b=0,c=this.length;c>b;b++)if(1===this[b].nodeType&&0<=(" "+this[b].className+" ").replace(Oa," ").indexOf(a))return!0;return!1}});var lc=/\r/g;d.fn.extend({val:function(a){var b,c,e,f=this[0];if(arguments.length)return e=d.isFunction(a),this.each(function(c){var f;1===this.nodeType&&(f=e?a.call(this,c,d(this).val()):a,null==f?f="":"number"==
